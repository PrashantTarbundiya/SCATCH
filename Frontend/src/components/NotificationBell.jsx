      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className="fixed top-20 right-2 left-2 sm:absolute sm:top-12 sm:right-0 sm:left-auto sm:w-96 bg-white border-4 border-black shadow-neo-lg z-50 max-h-[80vh] flex flex-col"
          >
            {/* Header */}
