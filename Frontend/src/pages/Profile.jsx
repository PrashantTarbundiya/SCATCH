...
function ProfilePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-gray-900 text-gray-800 dark:text-gray-200 transition-colors duration-300 pt-20 md:pt-24 pb-8 md:pb-12">
      <div className="w-full max-w-7xl mx-auto px-3 sm:px-4 md:px-6 lg:px-8">
        {/* Profile Header */}
        <div className="relative bg-gradient-to-r from-blue-500 to-indigo-600 dark:from-blue-700 dark:to-indigo-800 p-4 sm:p-6 md:p-8 rounded-lg shadow-xl mb-6 md:mb-10 text-white">
          <div className="flex flex-col md:flex-row items-center gap-4 md:gap-0">
            <img
              className="h-24 w-24 sm:h-32 sm:w-32 md:h-36 md:w-36 rounded-full object-cover border-4 border-white dark:border-gray-300 shadow-md md:mr-8"
            ...
            <Link
              to="/profile/edit"
              className="w-full md:w-auto md:ml-auto bg-white dark:bg-gray-700 text-blue-600 dark:text-blue-300 hover:bg-gray-100 dark:hover:bg-gray-600 font-semibold py-2 px-4 sm:px-5 rounded-lg shadow transition-colors flex items-center justify-center gap-2 text-sm sm:text-base"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-4 sm:gap-6 md:gap-8">
          ...
          <div className="lg:col-span-2 bg-white dark:bg-gray-800 p-4 sm:p-5 md:p-6 rounded-lg shadow-lg">
            <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 text-gray-700 dark:text-gray-100 border-b pb-2 sm:pb-3 border-gray-200 dark:border-gray-700 flex items-center gap-2">
              <i className="ri-user-line text-blue-500 dark:text-blue-400"></i>
              <span>Personal Info</span>
            </h2>
            <div className="space-y-3 sm:space-y-4">
              <div>
                <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">Full Name</p>
                <p className="text-base sm:text-lg break-words">{profileData.name}</p>
              </div>
              <div>
                <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">Email Address</p>
              ...
              <div>
                <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">Phone Number</p>
              ...
              <div>
                <p className="text-xs sm:text-sm text-gray-500 dark:text-gray-400 mb-1">Address</p>
          ...
          <div className="lg:col-span-3 bg-white dark:bg-gray-800 p-4 sm:p-5 md:p-6 rounded-lg shadow-lg">
            <h2 className="text-xl sm:text-2xl font-semibold mb-4 sm:mb-6 text-gray-700 dark:text-gray-100 border-b pb-2 sm:pb-3 border-gray-200 dark:border-gray-700 flex items-center gap-2">
              <i className="ri-shopping-bag-3-line text-green-500 dark:text-green-400"></i>
              <span>My Orders</span>
            </h2>
            {ordersLoading ? (
                ...
                {(() => {
                  ...
                  return (
                    <div className="space-y-4 sm:space-y-6">
                      <div className="p-3 sm:p-4 border border-gray-200 dark:border-gray-700 rounded-lg bg-white dark:bg-gray-800 shadow-md">
                        <div className="flex flex-col sm:flex-row justify-between sm:items-center mb-3 gap-2">
                          <div className="flex-1">
                            <span className="font-semibold text-base sm:text-lg text-gray-800 dark:text-gray-100 block break-words">
                        ...
                        <div className="mb-3">
                          <h4 className="font-medium text-sm sm:text-base text-gray-700 dark:text-gray-300 mb-2">Items:</h4>
                          <ul className="list-disc list-inside pl-1 space-y-1.5 text-xs sm:text-sm text-gray-600 dark:text-gray-400 max-h-32 sm:max-h-40 overflow-y-auto custom-scrollbar pr-1">
                        ...
                        <div className="border-t border-gray-200 dark:border-gray-600 pt-2 mt-2 text-right">
                          <p className="text-sm sm:text-base md:text-lg font-semibold text-gray-800 dark:text-gray-100">
                ...
                {orders.length > 1 && (
                  <div className="flex justify-between items-center mt-4 gap-2">
                    <button
                      ...
                      className="px-3 sm:px-4 py-2 bg-gray-300 dark:bg-gray-600 text-gray-800 dark:text-gray-200 rounded-md hover:bg-gray-400 dark:hover:bg-gray-500 disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
                    >
              ...
              <div className="text-center py-8 sm:py-12">
                <i className="ri-dropbox-line text-4xl sm:text-5xl text-gray-400 dark:text-gray-500 mb-3"></i>
                <p className="text-sm sm:text-base text-gray-500 dark:text-gray-400 mb-4">You have no orders yet.</p>
                <Link
                  to="/shop"
                  className="inline-block bg-blue-500 hover:bg-blue-600 text-white font-semibold py-2 px-4 sm:px-6 rounded-lg transition-colors text-sm sm:text-base"
                >
                  Start Shopping
                </Link>
              </div>
